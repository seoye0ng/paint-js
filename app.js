...
const INITIAL_COLOR = "#2c2c2c"; //이런 variable들은 반복하게되면 만든다.
...
ctx.strokeStyle = INITIAL_COLOR; //첫 번째색(검정색)으로 시작하도록 설정
...
function handleColorClick(event) {
  ...
  ctx.fillStyle = color; //color를 클릭하면 strokeStyle과 fillStyle을 color값으로 설정
}
